...
import fiek.ds.android.fieknote.widget.ListWidgetProvider;
...
public class BaseActivity extends ActionBarActivity {
    ...
    public static void notifyAppWidgets(Context context) {
        ...
        mgr.notifyAppWidgetViewDataChanged(ids, fiek.ds.android.fieknote.R.id.widget_list);
    ...
    protected void animateTransition(FragmentTransaction transaction, int direction) {
        if (direction == TRANSITION_HORIZONTAL) {
            transaction.setCustomAnimations(fiek.ds.android.fieknote.R.anim.fade_in_support, fiek.ds.android.fieknote.R.anim.fade_out_support,
                    fiek.ds.android.fieknote.R.anim.fade_in_support, fiek.ds.android.fieknote.R.anim.fade_out_support);
        }
        if (direction == TRANSITION_VERTICAL && Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            transaction.setCustomAnimations(
                    fiek.ds.android.fieknote.R.anim.anim_in, fiek.ds.android.fieknote.R.anim.anim_out, fiek.ds.android.fieknote.R.anim.anim_in_pop, fiek.ds.android.fieknote.R.anim.anim_out_pop);
        }
    }
