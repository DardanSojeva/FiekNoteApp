...
import fiek.ds.android.fieknote.models.holders.ImageAndTextItem;
...
public class ImageAndTextAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(fiek.ds.android.fieknote.R.layout.image_and_text_item,
                    parent, false);
            ...
            holder.image = (ImageView) convertView.findViewById(fiek.ds.android.fieknote.R.id.image);
            holder.text = (TextView) convertView.findViewById(fiek.ds.android.fieknote.R.id.text);
