...
import fiek.ds.android.fieknote.async.upgrade.UpgradeProcessor;
...
import fiek.ds.android.fieknote.utils.AssetUtils;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    {
		return getInstance(FiekNote.getAppContext());
	}
