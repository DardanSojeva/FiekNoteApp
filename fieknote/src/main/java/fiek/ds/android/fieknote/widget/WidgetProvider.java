...
public abstract class WidgetProvider extends AppWidgetProvider {
    ...
    public static String EXTRA_WORD = "it.feio.android.fieknote.widget.WORD";
    public static String TOAST_ACTION = "it.feio.android.fieknote.widget.NOTE";
    public static String EXTRA_ITEM = "it.feio.android.fieknote.widget.EXTRA_FIELD";
    ...
    private void setLayout(Context context, AppWidgetManager appWidgetManager, int widgetId) {
        ...
        map.put(fiek.ds.android.fieknote.R.id.list, pendingIntentList);
        map.put(fiek.ds.android.fieknote.R.id.add, pendingIntentDetail);
        map.put(fiek.ds.android.fieknote.R.id.camera, pendingIntentDetailPhoto);
