...
public class TextHelper {
    ...
    public static String getDateText(Context mContext, Note note, int navigation) {
        ...
        switch (sort_column) {
            case DbHelper.KEY_CREATION:
				dateText = mContext.getString(fiek.ds.android.fieknote.R.string.creation) + " " + DateHelper.getFormattedDate(note.getCreation
            ...
            case DbHelper.KEY_REMINDER:
				...
				if (TextUtils.isEmpty(noteReminder)) {
					dateText = mContext.getString(fiek.ds.android.fieknote.R.string.no_reminder_set);
				} else {
					dateText = mContext.getString(fiek.ds.android.fieknote.R.string.alarm_set_on) + " " + DateHelper.getDateTimeShort(mContext,
							Long.parseLong(noteReminder));
				}
				break;
            default:
				dateText = mContext.getString(fiek.ds.android.fieknote.R.string.last_update) + " " + DateHelper.getFormattedDate(note
	...
	public static String getAlternativeTitle(Context context, Note note, Spanned spanned) {
		...
		return context.getString(fiek.ds.android.fieknote.R.string.note) + " " + context.getString(fiek.ds.android.fieknote.R.string.creation) + " " + DateHelper
