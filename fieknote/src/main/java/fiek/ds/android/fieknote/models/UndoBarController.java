...
//        mBarAnimator = mBarView.animate();
        ...
        mMessageView = (TextView) mBarView.findViewById(fiek.ds.android.fieknote.R.id.undobar_message);

        mButtonView = (Button) mBarView.findViewById(fiek.ds.android.fieknote.R.id.undobar_button);
