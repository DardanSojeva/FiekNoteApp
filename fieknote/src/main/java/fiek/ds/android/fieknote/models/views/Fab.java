...
import fiek.ds.android.fieknote.models.listeners.OnFabItemClickedListener;
import fiek.ds.android.fieknote.utils.Display;
import it.feio.android.checklistview.utils.DensityUtil;
import fiek.ds.android.fieknote.models.listeners.AbsListViewScrollDetector;
...
public class Fab {
    ...
    private void init() {
        ...
        AddFloatingActionButton fabAddButton = (AddFloatingActionButton) fab.findViewById(fiek.ds.android.fieknote.R.id.fab_expand_menu_button);
        ...
        fab.findViewById(fiek.ds.android.fieknote.R.id.fab_checklist).setOnClickListener(onClickListener);
        fab.findViewById(fiek.ds.android.fieknote.R.id.fab_camera).setOnClickListener(onClickListener);

        if (!expandOnLongClick) {
            View noteBtn = fab.findViewById(fiek.ds.android.fieknote.R.id.fab_note);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            int navBarHeight = Display.getNavigationBarHeightKitkat(FiekNote.getAppContext());
            FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) fab.getLayoutParams();
            params.setMargins(params.leftMargin, params.topMargin, params.rightMargin,
                    navBarHeight + DensityUtil.pxToDp(params.bottomMargin, FiekNote.getAppContext()));
    ...
    public void setOverlay(int colorResurce) {
        View overlayView = new View(FiekNote.getAppContext());
