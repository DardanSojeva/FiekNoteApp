...
import fiek.ds.android.fieknote.async.UpdaterTask;
...
import fiek.ds.android.fieknote.intro.IntroActivity;
...
public class MainActivity extends BaseActivity implements OnDateSetListener, OnTimeSetListener {
    ...
    @Bind(fiek.ds.android.fieknote.R.id.drawer_layout) DrawerLayout drawerLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		setTheme(fiek.ds.android.fieknote.R.style.FiekNotesTheme_ApiSpec);
        setContentView(fiek.ds.android.fieknote.R.layout.activity_main);
	...
	private void init() {
        ...
        NavigationDrawerFragment mNavigationDrawerFragment = (NavigationDrawerFragment) mFragmentManager
                .findFragmentById(fiek.ds.android.fieknote.R.id.navigation_drawer);
        if (mNavigationDrawerFragment == null) {
            FragmentTransaction fragmentTransaction = mFragmentManager.beginTransaction();
            fragmentTransaction.replace(fiek.ds.android.fieknote.R.id.navigation_drawer, new NavigationDrawerFragment(),
                    FRAGMENT_DRAWER_TAG).commit();
        }

        if (mFragmentManager.findFragmentByTag(FRAGMENT_LIST_TAG) == null) {
            FragmentTransaction fragmentTransaction = mFragmentManager.beginTransaction();
            fragmentTransaction.add(fiek.ds.android.fieknote.R.id.fragment_container, new ListFragment(), FRAGMENT_LIST_TAG).commit();
        }
    ...
    public MenuItem getSearchMenuItem() {
        Fragment f = checkFragmentInstance(fiek.ds.android.fieknote.R.id.fragment_container, ListFragment.class);
        if (f != null) {
    ...
    public void onBackPressed() {
        ...
        // SketchFragment
        f = checkFragmentInstance(fiek.ds.android.fieknote.R.id.fragment_container, SketchFragment.class);
        if (f != null) {
        ...
        // DetailFragment
        f = checkFragmentInstance(fiek.ds.android.fieknote.R.id.fragment_container, DetailFragment.class);
        if (f != null) {
        ...
        // ListFragment
        f = checkFragmentInstance(fiek.ds.android.fieknote.R.id.fragment_container, ListFragment.class);
        if (f != null) {
    ...
    public ActionBarDrawerToggle getDrawerToggle() {
        if (mFragmentManager != null && mFragmentManager.findFragmentById(fiek.ds.android.fieknote.R.id.navigation_drawer) != null) {
            return ((NavigationDrawerFragment) mFragmentManager.findFragmentById(fiek.ds.android.fieknote.R.id.navigation_drawer)).mDrawerToggle;
        } else {
            return null;
        }
    }
    ...
    private void saveAndExit(Intent i) {
        ...
        showToast(getString(fiek.ds.android.fieknote.R.string.note_updated), Toast.LENGTH_SHORT);
        finish();
    }
    ...
    public void switchToList() {
        ...
        transaction.replace(fiek.ds.android.fieknote.R.id.fragment_container, mListFragment, FRAGMENT_LIST_TAG).addToBackStack
    ...
    public void switchToDetail(Note note) {
        ...
        if (mFragmentManager.findFragmentByTag(FRAGMENT_DETAIL_TAG) == null) {
            transaction.replace(fiek.ds.android.fieknote.R.id.fragment_container, mDetailFragment, FRAGMENT_DETAIL_TAG).addToBackStack
    ...
    public void shareNote(Note note) {
        ...
        startActivity(Intent.createChooser(shareIntent, getResources().getString(fiek.ds.android.fieknote.R.string.share_message_chooser)));
    }
