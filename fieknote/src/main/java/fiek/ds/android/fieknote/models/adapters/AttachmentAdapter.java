...
public class AttachmentAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(fiek.ds.android.fieknote.R.layout.gridview_item, parent, false);
            ...
            holder.image = (SquareImageView) convertView.findViewById(fiek.ds.android.fieknote.R.id.gridview_item_picture);
            holder.text = (TextView) convertView.findViewById(fiek.ds.android.fieknote.R.id.gridview_item_text);
        ...
        if (mAttachment.getMime_type() != null && mAttachment.getMime_type().equals(Constants.MIME_TYPE_AUDIO)) {
            ...
            if (text == null) {
                text = mActivity.getString(fiek.ds.android.fieknote.R.string.attachment);
            }
