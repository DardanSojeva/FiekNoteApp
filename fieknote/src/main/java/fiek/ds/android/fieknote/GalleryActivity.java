...
import fiek.ds.android.fieknote.models.views.InterceptorFrameLayout;
...
public class GalleryActivity extends ActionBarActivity {
    ...
    @Bind(fiek.ds.android.fieknote.R.id.gallery_root) InterceptorFrameLayout galleryRootView;
    @Bind(fiek.ds.android.fieknote.R.id.fullscreen_content)  GalleryViewPager mViewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(fiek.ds.android.fieknote.R.layout.activity_gallery);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(fiek.ds.android.fieknote.R.menu.menu_gallery, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                onBackPressed();
                break;
            case fiek.ds.android.fieknote.R.id.menu_gallery_share: {
                shareMedia();
                break;
            }
            case fiek.ds.android.fieknote.R.id.menu_gallery: {
                viewMedia();
                break;
            }
        }
