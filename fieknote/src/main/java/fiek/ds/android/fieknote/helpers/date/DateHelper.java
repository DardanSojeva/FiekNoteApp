...
package fiek.ds.android.fieknote.helpers.date;
...
public class DateHelper {
    ...
    public static String getNoteReminderText(long reminder) {
        return FiekNote.getAppContext().getString(fiek.ds.android.fieknote.R.string.alarm_set_on) + " " + getDateTimeShort(FiekNote
				.getAppContext(), reminder);
    }


    public static String getNoteRecurrentReminderText(long reminder, String rrule) {
        return DateHelper.formatRecurrence(FiekNote.getAppContext(), rrule) + " " + FiekNote.getAppContext().getString
                (fiek.ds.android.fieknote.R.string.starting_from) + " " + DateHelper.getDateTimeShort(FiekNote.getAppContext(), reminder);
    }


	public static String getFormattedDate(Long timestamp, boolean prettified) {
		if(prettified) {
			return fiek.ds.android.fieknote.utils.date.DateUtils.prettyTime(timestamp);
		} else {
			return DateHelper.getDateTimeShort(FiekNote.getAppContext(), timestamp);
		}
	}
