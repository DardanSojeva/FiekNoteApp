...
public class NavDrawerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(fiek.ds.android.fieknote.R.layout.drawer_list_item, parent, false);
        ...
        if (isSelected(position)) {
            ...
            int color = mActivity.getResources().getColor(fiek.ds.android.fieknote.R.color.colorPrimaryDark);
    ...
    private boolean isSelected(int position) {
        ...
        String[] navigationListCodes = mActivity.getResources().getStringArray(fiek.ds.android.fieknote.R.array.navigation_list_codes);
        ...
        String navigationLocalized = mActivity.getResources().getStringArray(fiek.ds.android.fieknote.R.array.navigation_list)[index];
