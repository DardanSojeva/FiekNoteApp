...
public class NoteWithAudioAndCategory extends ActivityInstrumentationTestCase2<MainActivity> {
	...
	public void testCategory() {
		...
		solo.clickOnView(solo.getView(fiek.ds.android.fieknote.R.id.menu_category));
		//Add new category
		...
		// Save category
		solo.clickOnView(solo.getView(fiek.ds.android.fieknote.R.id.save));
		...
		//Delete category
		solo.clickOnView(solo.getView(fiek.ds.android.fieknote.R.id.delete));
		//Confirm deletion
		solo.clickOnView(solo.getView(com.afollestad.materialdialogs.R.id.buttonDefaultPositive));
		solo.sleep(500);
